...
const INIT_PRIVS_RELATION_ID: Oid = 3394;
const INIT_PRIVS_OBJ_INDEX_ID: Oid = 3395;
...
pub fn RemoveRoleFromInitPriv<'mcx>(
    ...
    let rel = table::table_open(mcx, INIT_PRIVS_RELATION_ID, RowExclusiveLock)?;
    let desc = rel.descr();
    ...
    let mut scan = genam::systable_beginscan(mcx, &rel, INIT_PRIVS_OBJ_INDEX_ID, true, None, &keys)?;
